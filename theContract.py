#This is a smartcontract test file, it is not in production and does not include any private keys, please add your own and test it yourself prior to using it.
import time
import sys
...
contract helloworld {
 function helloWorld () public pure returns (string) {
   return 'Hello to the blockchain world,  this is a test contract';
 }
}'''
...
while txn_receipt is None and (count < 30):
    try:
        ...
        print('Waiting for transaction to be approved by Batman maybe.. who knows... ({})'.format(count),end='\r')
        count+=1
        time.sleep(5)
